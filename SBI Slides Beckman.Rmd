...
date: |
  ...
  | August 3, 2017
  | 
  | <https://mdbeckman.github.io/JSM2017-Baltimore/>
...
- Design  
    ...
    - StatKey + Minitab  
    - In-class exams
    - Group projects (using Michael Bulmer's *The Islands*)
...
- Pedagogical opportunities 
    ...
    - Large enrollment 
    - Intersection of SBI & large enrollment
- Translating small class pedagogy effectively to the large class environment is worth our effort & attention 
